        ...
        <>
          <SearchSection1>
            {artists?.items?.length !== 0 && (
              <>
                <SearchProfileContainer>
                  <SearchTitleCategory>Result</SearchTitleCategory>
                  <Link
                    href={{
                      pathname: "/artist/[pid]/",
                      query: {
                  ...
                  >
                    <SearchArstitMainDesc>
                      ...
                      <SearchArtist>{artists?.items[0]?.name}</SearchArtist>
                    </SearchArstitMainDesc>
                  </Link>
                </SearchProfileContainer>
              </>
            ...
            {tracks?.items?.length !== 0 && (
              <SearchTracksContainer>
                <SearchTitleCategory>Tracks</SearchTitleCategory>
                {tracks?.items
          ...
          <aside>
            {playlists?.items?.length !== 0 && (
              <UserPublicPlaylist title="Playlists" data={playlists?.items} />
            )}
          </aside>
          <div>
            {artists?.items?.length !== 0 && (
              <>
                <SearchTitleCategory>Artist</SearchTitleCategory>
          ...
          <div>
            {albums && albums?.items?.length !== 0 && (
              <>
                <SearchTitleCategory>Albums</SearchTitleCategory>
                <SSwiper.SwiperContainer>
                  <SSwiper.SwiperMain
                    className="mySwiper"
                    modules={[Navigation]}
